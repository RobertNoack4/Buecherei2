    ...
    public static class Menues
    {
        public static void HauptMenue()
        {
            ...
            do
            {
                ...
                auswahl = MenueServices.EingabeZahl();
                switch (auswahl)
                {
        ...
        private static void Erstellen(int option)
        {
            if (option == 1)
            {
                ...
                pages = MenueServices.EingabeZahl(false);

                Console.WriteLine("Bitte geben sie das Erscheinungsjahr des Buches ein:");
                year = MenueServices.EingabeZahl(false);
            ...
            else if (option == 2)
            {
                ...
                int auswahl = MenueServices.EingabeZahl(false, Listen.ProduktListeAusgeben().Count);
            ...
            else if (option == 3)
            {
                ...
                int auswahl = MenueServices.EingabeZahl(true);
        ...
        private static void Anzeigen(int option)
        {
            ...
            switch (option)
            {
                case 1:
                    ...
                    int genauereInfos = MenueServices.EingabeZahl(true,exemplare.Count);
        ...
        private static void InformationenAnpassen(int option)
        {
            ...
            switch (option)
            {
                case 1:
                    ...
                    genauereInfos = MenueServices.EingabeZahl(true, alleProdukte.Count); 
                ...
                case 2:
                    ...
                    genauereInfos = MenueServices.EingabeZahl(false, alleProdukte.Count);
                    product = Listen.ProduktListeAusgeben()[genauereInfos - 1];
                    ...
                    int exemplarIndex = MenueServices.EingabeZahl(true);
                ...
                case 3:
                    ...
                    eingabe = Console.ReadLine();
                    int auswahl = MenueServices.EingabeZahl(true, Listen.LeihvorgangListeLaenge());
        ...
        private static void Loeschen(int option)
        {
            ...
            switch (option)
            {
                case 1:
                    ...
                    auswahl = MenueServices.EingabeZahl(true, Listen.LeihvorgangListeLaenge());
                    product = Listen.ProduktListeAusgeben()[auswahl - 1];
                ...
                case 2:
                    AllgemeineInfos(1);
                    Console.WriteLine("Bitte geben sie den Index des Produktes ein von welchem sie ein Exemplar löschen möchten");

                    eingabe = Console.ReadLine();
                    auswahl = MenueServices.EingabeZahl(true, Listen.ProduktListeLaenge());
                    product = Listen.ProduktListeAusgeben()[auswahl - 1];
                    List<Exemplar> alleExemplare = product.AlleExemplareAusgeben();

                    ExemplarAusgeben(product);
                    eingabe = Console.ReadLine();
                    auswahl = MenueServices.EingabeZahl(true, Listen.ExemplarListeLaenge());
                ...
                case 3:
                    AllgemeineInfos(3);
                    Console.WriteLine("Bitte wählen sie aus welchen Leihvorgang sie löschen wollen");
                    eingabe = Console.ReadLine();
                    auswahl = MenueServices.EingabeZahl(true, Listen.LeihvorgangListeLaenge());
                    leihVorgang = Listen.LeihVorgangsListeAusgeben()[auswahl - 1];
        ...
        private static void InformationenAnpassenInt(string art, IProduct product)
        {
            ...
            if (!String.IsNullOrWhiteSpace(aenderung))
            {
                ...
                {
                    sicher = false;
                    int aenderungInt = MenueServices.EingabeZahl(false);
