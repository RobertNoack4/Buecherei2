...
namespace Buecherei.Properties
{
    public static class Listen
    {
        ...
        public static int ProduktListeLaenge()
        {
            return produktListe.Count;
        }
        ...
        public static int LeihvorgangListeLaenge()
        {
            return leihvorgaenge.Count;
        }
        ...
        public static int ExemplarListeLaenge()
        {
            return exemplarListe.Count;
        }
